...
export const evidence: Evidence[] = [
  ...
  { id: "ev-audio-0712", index: "E-08", title: "纸带高频口令 0712", type: "audio", description: "高通、0.75 倍速与后半段定位共同显露案件日期口令；通话也确认林知夏曾复制资料。", acquiredAt: "完成录音解析", source: "纸带 A", relatedPeople: ["lin-zhixia", "tang-zhi"], relatedLocations: ["loc-archive"], relatedTime: "00:39", critical: true, unlockAfter: "frequency", relatedEvidence: ["ev-phone", "ev-tape-edit", "ev-photo"] },
  { id: "ev-tape-edit", index: "E-08B", title: "纸带剪接与 A-17 口令", type: "audio", description: "纸带末尾存在人工剪接；许晚澄关闭 A-17 后，安保巡检被延迟 126 秒。", acquiredAt: "完成录音解析", source: "纸带修复台", relatedPeople: ["xu-wancheng", "lin-zhixia"], relatedLocations: ["loc-weather"], relatedTime: "00:40", critical: false, unlockAfter: "frequency", relatedEvidence: ["ev-weather", "ev-audio-0712"] },
  ...
  { id: "ev-photo", index: "E-10", title: "白鹭七号完整照片", type: "photo", description: "拼合后可见船号 H-1707、检修梯旁第二道人影，以及监控室窗口一处仍亮着的控制灯。", acquiredAt: "完成照片拼合", source: "监控室扫描仪", relatedPeople: ["gu-weian", "chen-mu", "zhou-jiming"], relatedLocations: ["loc-pier7", "loc-control"], relatedTime: "00:43", critical: true, unlockAfter: "photo", relatedEvidence: ["ev-port-log", "ev-toolbox", "ev-cctv", "ev-manifest"] },
  ...
  { id: "ev-payment", index: "E-15", title: "异常付款批次", type: "record", description: "澜汐航运在事发后向周既明与顾惟安关联账户付款。", acquiredAt: "完成照片交叉核验", source: "审计碎片", relatedPeople: ["zhou-jiming", "gu-weian"], relatedLocations: ["loc-archive"], relatedTime: "2019.07.16", critical: false, unlockAfter: "photo", relatedEvidence: ["ev-manifest", "ev-closure-order"] },
  { id: "ev-medical-context", index: "E-15B", title: "医院缴费单与未发送语音", type: "record", description: "顾惟安女儿的急诊治疗面临停缴；语音证明他在威胁下开闸、擦除记录，但清楚自己正在协助作伪。", acquiredAt: "最终档案解锁", source: "审计附件", relatedPeople: ["gu-weian"], relatedLocations: ["loc-gate"], relatedTime: "00:16—01:12", critical: false, unlockAfter: "deduction", relatedEvidence: ["ev-payment", "ev-port-log"] },
